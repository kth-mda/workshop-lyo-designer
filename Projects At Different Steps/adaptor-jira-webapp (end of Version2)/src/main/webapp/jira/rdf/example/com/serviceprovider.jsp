...
End of user code
  ...
  (<a href="<%= request.getContextPath() %>/jira/rdf/example/com/selectiondialogsampleclient.jsp?selectionUri=<%= URLEncoder.encode(selectionDialog.toString(), "UTF-8") %>">sample client</a>)
            </p>
          <%}%>
  ...
  (<a href="<%= request.getContextPath() %>/jira/rdf/example/com/creationdialogsampleclient.jsp?creationUri=<%= URLEncoder.encode(creationDialog.toString(), "UTF-8") %>">sample client</a>)
